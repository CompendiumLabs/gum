...
class Points extends Group {
    constructor({ children: children0, points, rad = 0.01, shape, ...attr0 } = {}) {
...
class SymPoints extends Group {
    constructor({ children: children0, fx, fy, fs, fr, size = 0.01, shape, xlim, ylim, tlim, xvals, yvals, tvals, N, ...attr } = {}) {
        shape = shape ?? (a => new Dot(a))
