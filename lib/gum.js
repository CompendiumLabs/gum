...
class ArrowPath extends Group {
    constructor({ children: children0, pos_beg, pos_end, direc_beg, direc_end, arrow, arrow_beg, arrow_end, arrow_size = 0.03, coord, ...attr0 } = {}) {
        ...
        const path = new CubicSpline({ pos0: pos_beg, pos1: pos_end, direc0: vector_beg, direc1: vector_end, coord, ...path_attr })
        const children = [ path ]
...
class Network extends Group {
    constructor({ children: children0, coord, ...attr } = {}) {
        ...
        const paths = edges.map(e => {
            ...
            return new ArrowPath({ pos_beg, pos_end, direc_beg: direc1, direc_end: direc2, coord, ...e.attr })
        })
