...
function rotate_rect(size, aspect, rotate, expand=false, tol=0.001) {
...
class Context {
    ...
    map({ rect, aspect = null, expand = false, align = 'center', rotate = 0, coord = coord_base } = {}) {
        ...
        // rotate rect inside
        const [ w, h ] = rotate_rect([ w0, h0 ], aspect, rotate, expand)
...
// spec keys
const spec_keys = [ 'rect', 'aspect', 'expand', 'align', 'rotate', 'coord' ]
